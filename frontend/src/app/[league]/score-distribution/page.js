      ...
      <main className="max-w-7xl mx-auto px-6 py-12 pt-24">
        <div className="mb-8 px-4 sm:px-0">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className={`text-3xl sm:text-4xl font-bold mb-2 ${getTextColor()}`}>{code} Score Distribution</h1>
              <p className={getSubTextColor()}>Score patterns and distribution charts</p>
            </div>
        ...
        <ScoreDistribution leagueCode={code} />
      </main>
    </div>
  );
}
