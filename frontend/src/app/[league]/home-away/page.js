...
export default function HomeAwayPage() {
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 pt-24">
        <div className="mb-8 px-4 sm:px-0">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className={`text-3xl sm:text-4xl font-bold mb-2 ${getTextColor()}`}>{code} Home vs Away</h1>
              <p className={getSubTextColor()}>Home and away team performance statistics</p>
            </div>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Link
                href={`/${league}/players`}
                className="px-4 sm:px-6 py-3 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-lg transition-all flex items-center space-x-2 touch-manipulation"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
